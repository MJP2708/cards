...
// Consolidates the lower-frequency toggles (language, dark mode)
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-expanded={open}
        className="flex items-center justify-center rounded-md border border-border-1 px-2.5 py-1.5 hover:bg-surface-1"
      >
